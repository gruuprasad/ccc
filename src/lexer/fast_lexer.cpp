...
inline bool FastLexer::munchIdentifier() {
  ...
  token_list.emplace_back(TokenType::IDENTIFIER,
                          ...
                          std::string(&content[oldPosition], position - oldPosition));
  if (this->tokenize)
    std::printf("%s:%ld:%ld: identifier %s\n",
                filename,
                line,
                column + 1,
                std::string(&content[oldPosition], position - oldPosition).c_str());
...
inline bool FastLexer::munchString() {
  ...
  if (this->tokenize)
    std::printf("%s:%ld:%ld: string-literal \"%s\"\n",
                filename,
                line,
                initColumn + 1,
...
inline bool FastLexer::isKeyword() {
  ...
  case 'a':
    if (getCharAt(position + 1) == 'u'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword auto\n", filename, line, column + 1);
      position += 4;
      column += 4;
      return true;
    }
  ...
  case 'b':
    if (getCharAt(position + 1) == 'r'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword break\n", filename, line, column + 1);
      position += 5;
      column += 5;
      return true;
    }
  ...
  case 'c':
    ...
    case 'a':
      if (getCharAt(position + 2) == 's'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword case\n", filename, line, column + 1);
        position += 4;
        column += 4;
        return true;
      }
    ...
    case 'h':
      if (getCharAt(position + 2) == 'a'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword char\n", filename, line, column + 1);
        position += 4;
        column += 4;
        return true;
      }
    ...
    case 'o':
      if (getCharAt(position + 2) == 'n') {
        if (getCharAt(position + 3) == 's'
          ...
          if (this->tokenize)
            std::printf("%s:%ld:%ld: keyword const\n", filename, line, column + 1);
          position += 5;
          column += 5;
          return true;
        }
        if (getCharAt(position + 3) == 't'
          ...
          if (this->tokenize)
            std::printf("%s:%ld:%ld: keyword continue\n", filename, line, column + 1);
          position += 8;
          column += 8;
          return true;
        }
  ...
  case 'd':
    if (getCharAt(position + 1) == 'o') {
      if (getCharAt(position + 2) == 'u'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword double\n", filename, line, column + 1);
        position += 6;
        column += 6;
        return true;
      }
    ...
    if (getCharAt(position + 1) == 'e'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword default\n", filename, line, column + 1);
      position += 7;
      column += 7;
      return true;
    }
  ...
  case 'e':
    ...
    case 'l':
      if (getCharAt(position + 2) == 's'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword else\n", filename, line, column + 1);
        position += 4;
        column += 4;
        return true;
      }
    ...
    case 'n':
      if (getCharAt(position + 2) == 'u'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword enum\n", filename, line, column + 1);
        position += 4;
        column += 4;
        return true;
      }
    ...
    case 'x':
      if (getCharAt(position + 2) == 't'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword extern\n", filename, line, column + 1);
        position += 6;
        column += 6;
        return true;
      }
  ...
  case 'f':
    if (getCharAt(position + 1) == 'o'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword for\n", filename, line, column + 1);
      position += 3;
      column += 3;
      return true;
    }
    if (getCharAt(position + 1) == 'l'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword float\n", filename, line, column + 1);
      position += 5;
      column += 5;
      return true;
    }
  ...
  case 'g':
    if (getCharAt(position + 1) == 'o'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword goto\n", filename, line, column + 1);
      position += 4;
      column += 4;
      return true;
    }
  ...
  case 'i':
    ...
    case 'n':
      if (getCharAt(position + 2) == 't'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword int\n", filename, line, column + 1);
        position += 3;
        column += 3;
        return true;
      }
      if (getCharAt(position + 2) == 'l'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword inline\n", filename, line, column + 1);
        position += 6;
        column += 6;
        return true;
      }
  ...
  case 'l':
    if (getCharAt(position + 1) == 'o'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword long\n", filename, line, column + 1);
      position += 4;
      column += 4;
      return true;
    }
    ...
    if (getCharAt(position + 1) == 'e') {
      ...
      case 'g':
        if (getCharAt(position + 3) == 'i'
          ...
          if (this->tokenize)
            std::printf("%s:%ld:%ld: keyword register\n", filename, line, column + 1);
          position += 8;
          column += 8;
          return true;
        }
      ...
      case 's':
        if (getCharAt(position + 3) == 't'
          ...
          if (this->tokenize)
            std::printf("%s:%ld:%ld: keyword restrict\n", filename, line, column + 1);
          position += 8;
          column += 8;
          return true;
        }
      ...
      case 't':
        if (getCharAt(position + 3) == 'u'
          ...
          if (this->tokenize)
            std::printf("%s:%ld:%ld: keyword return\n", filename, line, column + 1);
          position += 6;
          column += 6;
          return true;
        }
  ...
  case 's':
    ...
    case 'h':
      if (getCharAt(position + 2) == 'o'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword short\n", filename, line, column + 1);
        position += 5;
        column += 5;
        return true;
      }
    ...
    case 'i':
      if (getCharAt(position + 2) == 'g'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword signed\n", filename, line, column + 1);
        position += 6;
        column += 6;
        return true;
      }
      if (getCharAt(position + 2) == 'z'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword sizeof\n", filename, line, column + 1);
        position += 6;
        column += 6;
        return true;
      }
    ...
    case 't':
      if (getCharAt(position + 2) == 'a'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword static\n", filename, line, column + 1);
        position += 6;
        column += 6;
        return true;
      }
      if (getCharAt(position + 2) == 'r'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword struct\n", filename, line, column + 1);
        position += 6;
        column += 6;
        return true;
      }
    ...
    case 'w':
      if (getCharAt(position + 2) == 'i'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword switch\n", filename, line, column + 1);
        position += 6;
        column += 6;
        return true;
      }
  ...
  case 't':
    if (getCharAt(position + 1) == 'y'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword typedef\n", filename, line, column + 1);
      position += 7;
      column += 7;
      return true;
    }
  ...
  case 'u':
    if (getCharAt(position + 1) == 'n') {
      if (getCharAt(position + 2) == 'i'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword union\n", filename, line, column + 1);
        position += 5;
        column += 5;
        return true;
      }
      if (getCharAt(position + 2) == 's'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword unsigned\n", filename, line, column + 1);
        position += 8;
        column += 8;
        return true;
      }
  ...
  case 'v':
    if (getCharAt(position + 1) == 'o') {
      if (getCharAt(position + 2) == 'i'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword void\n", filename, line, column + 1);
        position += 4;
        column += 4;
        return true;
      }
      if (getCharAt(position + 2) == 'l'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword volatile\n", filename, line, column + 1);
        position += 8;
        column += 8;
        return true;
      }
  ...
  case 'w':
    if (getCharAt(position + 1) == 'h'
      ...
      if (this->tokenize)
        std::printf("%s:%ld:%ld: keyword while\n", filename, line, column + 1);
      position += 5;
      column += 5;
      return true;
    }
  ...
  case '_':
    ...
    case 'A':
      if (getCharAt(position + 2) == 'l'
        ...
        if (getCharAt(position + 6) == 'a'
          ...
          if (this->tokenize)
            std::printf("%s:%ld:%ld: keyword _Alignas\n", filename, line, column + 1);
          position += 8;
          column += 8;
          return true;
        }
        if (getCharAt(position + 6) == 'o'
          ...
          if (this->tokenize)
            std::printf("%s:%ld:%ld: keyword _Alignof\n", filename, line, column + 1);
          position += 8;
          column += 8;
          return true;
        }
      ...
      if (getCharAt(position + 2) == 't'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword _Atomic\n", filename, line, column + 1);
        position += 7;
        column += 7;
        return true;
      }
    ...
    case 'B':
      if (getCharAt(position + 2) == 'o'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword _Bool\n", filename, line, column + 1);
        position += 5;
        column += 5;
        return true;
      }
    ...
    case 'C':
      if (getCharAt(position + 2) == 'o'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword _Complex\n", filename, line, column + 1);
        position += 8;
        column += 8;
        return true;
      }
    ...
    case 'G':
      if (getCharAt(position + 2) == 'e'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword _Generic\n", filename, line, column + 1);
        position += 8;
        column += 8;
        return true;
      }
    ...
    case 'I':
      if (getCharAt(position + 2) == 'm'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword _Imaginary\n", filename, line, column + 1);
        position += 10;
        column += 10;
        return true;
      }
    ...
    case 'N':
      if (getCharAt(position + 2) == 'o'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword _Noreturn\n", filename, line, column + 1);
        position += 9;
        column += 9;
        return true;
      }
    ...
    case 'S':
      if (getCharAt(position + 2) == 't'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword _Static_assert\n", filename, line, column + 1);
        position += 14;
        column += 14;
        return true;
      }
    ...
    case 'T':
      if (getCharAt(position + 2) == 'h'
        ...
        if (this->tokenize)
          std::printf("%s:%ld:%ld: keyword _Thread_local\n", filename, line, column + 1);
        position += 13;
        column += 13;
        return true;
      }

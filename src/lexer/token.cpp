...
const std::string Token::name() const {
  ...
  case TokenType::ALIGN_AS:return "_Alignas";
  case TokenType::ALIGN_OF:return "_Alignof";
  case TokenType::ATOMIC:return "_Atomic";
  case TokenType::BOOL:return "_Bool";
  case TokenType::COMPLEX:return "_Complex";
  case TokenType::GENERIC:return "_Generic";
  case TokenType::IMAGINARY:return "_Imaginary";
  case TokenType::NO_RETURN:return "_Noreturn";
  case TokenType::STATIC_ASSERT:return "_Static_assert";
  case TokenType::THREAD_LOCAL:return "_Thread_local";
  case TokenType::BRACKET_OPEN:return "[";
  case TokenType::BRACKET_CLOSE:return "]";
  case TokenType::PARENTHESIS_OPEN:return "(";
  case TokenType::PARENTHESIS_CLOSE:return ")";
  ...
  case TokenType::AMPERSAND_ASSIGN:return "&=";
...
const std::string Token::token_type() const {
  ...
  case TokenType::RESTRICT:return "keyword";
  ...
  case TokenType::NO_RETURN:return "keyword";
...
const void Token::print(std::string filename) {
  std::printf("%s:%ld:%ld:%s ", filename.c_str(), this->line, this->column, this->token_type().c_str());

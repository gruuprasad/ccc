...
IfElseStatement::IfElseStatement(int id, Expression *expression, Statement *statement_1, Statement *statement_2)
...
GotoStatement::GotoStatement(int id, Expression *identifier) : Statement(id, "jump-statement", 1) {
  this->children.push_back(identifier);
}
...
ReturnStatement::ReturnStatement(int id, Expression *expression) : Statement(id, "jump-statement", 1) {
  this->children.push_back(expression);
}

...
TEST_CASE("Our parser should work.") {
  char *args[] = {
      (char*)"c4",
      (char*)"--parse",
      (char*)"../examples/test.c",
...
TEST_CASE("Our tokenizer should fail on invalid.") {
  char *args[] = {(char *) "c4", (char *) "--tokenize", (char *) "../examples/error.c", nullptr};
  REQUIRE(1 == EntryPointHandler().handle(3, args));
}

TEST_CASE("Our parser should fail on invalid.") {
  char *args[] = {(char *) "c4", (char *) "--parse", (char *) "../examples/error.c", nullptr};
  REQUIRE(1 == EntryPointHandler().handle(3, args));
}

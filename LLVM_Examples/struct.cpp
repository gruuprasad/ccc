...
int main(int argc, char **argv) {
  ...
  Value *VarGSAPtr = Builder.CreateInBoundsGEP(GlobVarGSPtr, ElementIndexes);

  /* Load the value of the element */
  LoadInst *ValGSA = Builder.CreateLoad(VarGSAPtr);


  /* Access the element 'b' of 'AS'
   *   0. Load the element 'AS' from the stack (it was an -> access !) */
  LoadInst *LocalVarASPtr = Builder.CreateLoad(ArgVarASPtrPtr);
  ...
  /* Use a getElementPointer (GEP) instruction to compute the offset from the
   * base pointer (here the GS pointer) */
  Value *VarASBPtr = Builder.CreateInBoundsGEP(LocalVarASPtr, ElementIndexes);

  /* Load the value of the element */
  LoadInst *ValASB = Builder.CreateLoad(VarASBPtr);
  ...
  /* Use a getElementPointer (GEP) instruction to compute the offset from the
   * base pointer (here the GS pointer) */
  Value *VarLSCPtr = Builder.CreateInBoundsGEP(LocalVarLSPtr, ElementIndexes);

  /* Load the value of the element */
  LoadInst *ValLSC = Builder.CreateLoad(VarLSCPtr);
  ...
  /* Use a getElementPointer (GEP) instruction to compute the offset from the
   * base pointer (here the GS pointer) */
  Value *VarLSDPtr = Builder.CreateInBoundsGEP(LocalVarLSPtr, ElementIndexes);

  /* Load the value of the element */
  LoadInst *ValLSD = Builder.CreateLoad(VarLSDPtr);
  ...
  /* Use a getElementPointer (GEP) instruction to compute the offset from the
   * base pointer (here the GS pointer) */
  Value *VarLSDCPtr = Builder.CreateInBoundsGEP(ValLSD, ElementIndexes);

  /* Load the value of the element */
  LoadInst *ValLSDC = Builder.CreateLoad(VarLSDCPtr);

...
int main(int argc, char **argv) {
   ...
   *  1. Load A and B */
  Value *ValA = Builder.CreateLoad(ArgVarAPtr);
  Value *ValB = Builder.CreateLoad(ArgVarBPtr);
  ...
  Value *ValA2 = Builder.CreateLoad(ArgVarAPtr);
   ...
   *   1. Load the value of B */
  Value *ValB2 = Builder.CreateLoad(ArgVarBPtr);

...
int main(int argc, char **argv) {
  ...
  Type *FormatType = Builder.getInt8PtrTy();
  ...
  FunctionType *FuncPrintfType = FunctionType::get(
      Builder.getInt32Ty(), ArgumentTypes, /* isVarArg */ true);
   ...
   *
   */
  Type *FuncMainReturnType = Builder.getInt32Ty();

  /* Create a vector to store all parameter types */
  std::vector<Type *> FuncMainParamTypes;

  /* Fill the vector with parameter types */
  FuncMainParamTypes.push_back(Builder.getInt32Ty());
  FuncMainParamTypes.push_back(PointerType::getUnqual(Builder.getInt8PtrTy()));
  ...
  Value *LocalVarIPtr = AllocaBuilder.CreateAlloca(Builder.getInt32Ty());
  ...
  Value *ValI = Builder.CreateLoad(LocalVarIPtr);
  Value *ValArgc = Builder.CreateLoad(ArgArgcPtr);
  ...
  /* Load the value of I */
  Value *ValI2 = Builder.CreateLoad(LocalVarIPtr);
  ...
  Value *ValArgv = Builder.CreateLoad(ArgArgvPtr);

  /* Compute the addr of the 'i-th' element of argv */
  Value *ArgvIthElemPtr = Builder.CreateGEP(ValArgv, ArgvIndices);

  /* Load the element */
  Value *ArgvIthElem = Builder.CreateLoad(ArgvIthElemPtr);

  /* Load the value of the global variable Format */
  Value *GlobVarFormatVal = Builder.CreateLoad(GlobVarFormatPtr);
  ...
  Value *OldIVal = Builder.CreateLoad(LocalVarIPtr);
